...
def highlight_matches_in_pdf(input_path, output_path, tnm_dict, matched_stages):
    try:
        ...
        t_color = (1, 1, 0)  # yellow for T stages
        n_color = (1, 1, 0)  # yellow for N stages
        m_color = (1, 1, 0)  # yellow for M stages
...
def main():
    ...
    input_folder = r"C:\Users\Md Shoaib\c tutorials course\Downloads\All Semesters Study Materials\Module VII\Project\Path Report"
    
    # Create output folder in the same directory
    output_folder = os.path.join(input_folder, "TNM_Results_new")
    os.makedirs(output_folder, exist_ok=True)
